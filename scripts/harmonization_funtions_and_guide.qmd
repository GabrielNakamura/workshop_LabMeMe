...
```{r}
exact_match1 <- harmonize_exact_match(base1_dtf = pbdb_taxa,
                                     base2_dtf = now_taxa,
                                     base1_suffix = "pbdb",
                                     base2_suffix = "now",
...
```{r}
a <- exact_match1$exact_match_found %>%
...
```{r}
pbdb_subgenus_deleted <- pbdb_taxa %>%
  filter(str_detect(pbdb_accepted_name, pattern = "\\(") | 
           str_detect(pbdb_internal_synonym, pattern = "\\(")) %>%
  mutate(pbdb_accepted_name_copy = pbdb_accepted_name,
         pbdb_internal_synonym_copy = pbdb_internal_synonym,
         across(contains("_copy"),
                ~str_replace_all(., pattern = "_\\(.*\\)", 
                                 replacement = "")))
pbdb_subgenus_swapped <- pbdb_taxa %>%
  filter(str_detect(pbdb_accepted_name, pattern = "\\(") | 
           str_detect(pbdb_internal_synonym, pattern = "\\(")) %>%
  mutate(pbdb_accepted_name_copy = pbdb_accepted_name,
         pbdb_internal_synonym_copy = pbdb_internal_synonym,
...
```{r}
exact_match2 <- harmonize_exact_match(base1_dtf = pbdb_subgenus_deleted,
                                     base2_dtf = now_taxa,
                                     base1_suffix = "pbdb",
                                     base2_suffix = "now",
                                     base1_col = "pbdb_accepted_name_copy",
                                     base2_col = "now_accepted_name")

exact_match3 <- harmonize_exact_match(base1_dtf = pbdb_subgenus_deleted,
                                     base2_dtf = now_taxa,
                                     base1_suffix = "pbdb",
                                     base2_suffix = "now",
                                     base1_col = "pbdb_internal_synonym_copy",
                                     base2_col = "now_accepted_name")

exact_match4 <- harmonize_exact_match(base1_dtf = pbdb_subgenus_swapped,
                                     base2_dtf = now_taxa,
                                     base1_suffix = "pbdb",
                                     base2_suffix = "now",
                                     base1_col = "pbdb_accepted_name_copy",
...
exact_match5 <- harmonize_exact_match(base1_dtf = pbdb_subgenus_swapped,
                                     base2_dtf = now_taxa,
                                     base1_suffix = "pbdb",
                                     base2_suffix = "now",
                                     base1_col = "pbdb_internal_synonym_copy",
...
```{r}
fuzzy_match4_min1max4 <- harmonize_fuzzy_match(base1_dtf = pbdb_subgenus_deleted,
                                     base2_dtf = now_taxa,
                                     base1_suffix = "pbdb",
                                     base2_suffix = "now",
                                     base1_col = "pbdb_accepted_name_copy",
...
fuzzy_match5_min1max4 <- harmonize_fuzzy_match(base1_dtf = pbdb_subgenus_deleted,
                                     base2_dtf = now_taxa,
                                     base1_suffix = "pbdb",
                                     base2_suffix = "now",
                                     base1_col = "pbdb_internal_synonym_copy",
...
fuzzy_match6_min1max4 <- harmonize_fuzzy_match(base1_dtf = pbdb_subgenus_swapped,
                                     base2_dtf = now_taxa,
                                     base1_suffix = "pbdb",
                                     base2_suffix = "now",
                                     base1_col = "pbdb_accepted_name_copy",
...
fuzzy_match7_min1max4 <- harmonize_fuzzy_match(base1_dtf = pbdb_subgenus_swapped,
                                     base2_dtf = now_taxa,
                                     base1_suffix = "pbdb",
                                     base2_suffix = "now",
                                     base1_col = "pbdb_internal_synonym_copy",
