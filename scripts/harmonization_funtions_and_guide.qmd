...
fuzzy.2b.min1max4.eval <- fuzzy.2b.min1max4.eval %>%
  mutate(accepted_match = case_when(
    pbdb_taxon_name == "Parenhydrocyon_josephi" & now_accepted_name == "Paraenhydrocyon_josephi" | 
      pbdb_taxon_name == "Sminthosinus_bowleri" & now_accepted_name == "Sminthosinis_bowleri" | 
      pbdb_taxon_name == "Deinictis_felina" & now_accepted_name == "Dinictis_felina" | 
      pbdb_taxon_name == "Deinictis_cyclops" & now_accepted_name == "Dinictis_cyclops" | 
      pbdb_taxon_name == "Lontra_canadensis" & now_accepted_name == "Lutra_canadensis" | 
      pbdb_taxon_name == "Athylax_paludinosus" & now_accepted_name == "Atilax_paludinosus" | 
      pbdb_taxon_name == "Amblonyx_cinerea" & now_accepted_name == "Aonyx_cinerea" | 
      pbdb_taxon_name == "Brachypsaloides_modicus" & now_accepted_name == "Brachypsalis_modicus" | 
      pbdb_taxon_name == "Ictonyx_capensis" & now_accepted_name == "Aonyx_capensis" | 
      pbdb_taxon_name == "Mustela_madisonae" & now_accepted_name == "Miomustela_madisonae" | 
      pbdb_taxon_name == "Phoca_hispida" & now_accepted_name == "Pusa_hispida" | 
      pbdb_taxon_name == "Pontoleon_magnus" & now_accepted_name == "Pontolis_magnus" | 
      pbdb_taxon_name == "Palaeogale_minuta" & now_accepted_name == "Palaeogale_minutus" | 
      pbdb_taxon_name == "Palaeogale_minuta" & now_accepted_name == "Palaeogale_minutus" | 
      pbdb_taxon_name == "Palaeogale_minuta" & now_accepted_name == "Palaeogale_minutus" | 
      pbdb_taxon_name == "Palaeogale_minuta" & now_accepted_name == "Palaeogale_minutus" | 
    
      pbdb_taxon_name == "Palaeogale_minuta" & now_accepted_name == "Palaeogale_minutus" | 
      pbdb_taxon_name == "Plionictis_oaxacaensis" & now_accepted_name == "Plionictis_oaxaquenis" ~ TRUE,
      #pbdb_taxon_name == "Cyon_antiquus" & now_accepted_name == "Cuon_antiquus" |
      #pbdb_taxon_name == "Vulpes_vulgaris" & now_accepted_name == "Vulpes_vulpes" |
      #pbdb_taxon_name == "Subparictis_dakotensis" & now_accepted_name == "Parictis_dakotensis" |
      #pbdb_taxon_name == "Dinocrocuta_algeriensis" & now_accepted_name == "Percrocuta_algeriensis" |
      #pbdb_taxon_name == "Phoca_hispida" & now_accepted_name == "Pusa_hispida"
      is.na(accepted_match) ~ FALSE,
      TRUE ~ accepted_match))
```
...
```{r}
finalSynonymy.2 <- finalSynonymy.2 %>%
  bind_rows(select(filter(fuzzy.2b.min1max4.eval, 
              accepted_match == TRUE),
       -accepted_match))
```
